...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-cybersec-black border-t border-cybersec-darkgray py-10 text-gray-400 w-full mt-auto">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-8 border-t border-cybersec-darkgray">
          <div>
        ...
        <div className="pt-8 border-t border-cybersec-darkgray text-sm text-center">
          <p className="mb-2">© {currentYear} VulnZero. Todos los derechos reservados.</p>
